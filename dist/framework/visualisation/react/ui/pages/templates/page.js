...
export var Page = function (props) {
    return (_jsxs("div", __assign({ className: 'flex flex-col w-full h-full gap-4' }, { children: [_jsx("div", __assign({ className: 'flex flex-row w-full gap-10 pt-20 pr-14' }, { children: _jsx("div", __assign({ className: 'flex-1 pl-14' }, { children: props.body })) })), _jsx("div", { className: 'flex-grow' }), _jsx("div", __assign({ className: 'h-footer flex-shrink-0' }, { children: props.footer }))] })));
};
